...
public class VProduktDefinieren extends VGrundFenster {
	...
	public void init() {
		...
		// Hauptpanel mit Borderlayout das in das Center des Superklassen
		// Borderlayout soll
		pnl_container_center = new JPanel(new BorderLayout());



		// Boxes um Labels und TextArea/Field besser anzuordnen
		...
		//Unterpanel im Borderlayout des 2ten Borderlayouts.
		...
		//Panel im 1.Borderlayout
		pnl_North_North = new JPanel(new BorderLayout());

		//Abstände zwischen den Textfeldern
		...
		// Hauptframe/panel konfigurieren
	...
	/**
	 * DocumentListener fuer btn_produktdef und die TextFields/Areas Bei
	 * jeglicher Änderung der Inhalte der TextFields/Areas wird überprüft ob sie
	 * leer sind Falls mindestens einer leer ist, ist der Button fürs
	 * Produktdefinieren ausgegraut, falls beide befüllt sind wird er anklickbar
	 * 
	 * @author toni
	 */
	 ...
	 * Speichert das Objekt über den Controller
	 * 
	 * @author toni
	 */
	public class Btn_produkt_definieren_ActionListener implements
	ActionListener {
		@Override
	...
	/**
	 * ActionListener fuer btn_zurueck verlässt das Produktdefinieren Fenster
	 * 
	 * @author toni
	 */
