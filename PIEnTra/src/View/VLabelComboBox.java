...
public class VLabelComboBox {
	 ...
	 * 
	 * @param pText
	 *            : Text für das Label vor der JComboBox
	 * 
	 * @author Leon
	 * @return
	 */
	 ...
	 *            : text für das Label vor der JComboBox
	 * @param pDimLbl
	 *            : Dimension für die präferierte Größe des Labels
	 * @param pDimCbx
	 *            : Dimension für die präferierte Größe der ComboBox
	...
	/**
	 * @return die Beschreibung, welche vor der ComboBox stehen wird. (Text des
	 *         Labels)
	 */
	 ...
	 * 
	 * @param pElement
	 *            : ist dasElements, welches in die ComboBox hinzugefuegt wird.
	 */
	 ...
	 * 
	 * @param pElements
	 *            : String Array mit den neuen Einträgen
	 */
	...
	public void addItemListenerAendern(
			View.VRessourceAendern.ItemChangeListener itemChangeListener) {
