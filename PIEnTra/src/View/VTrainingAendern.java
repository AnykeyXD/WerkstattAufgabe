...
public class VTrainingAendern extends VTraining {
	...
	/**
	 * ActionListener fuer btn_trainingSuchen zeigt VTrainingSuchen
	 * 
	 * @author joern
	 */
	...
	/**
	 * ActionListener fuer btn_ressourceAendern zeigt VRessourceAendern
	 * 
	 * @author joern
	 */
	...
	/**
	 * ActionListener fuer btn_trainingAktualisieren Uebernimmt gemachte
	 * Veraenderungen
	 * 
	 * @author joern
	 */
	public class Btn_training_aktualisieren_ActionListener implements ActionListener {
		@Override
		public void actionPerformed(ActionEvent e) {
			controller.training_aktualisieren(ltf_trainingsID.getText(), ltf_firmenName.getText(),
					ltf_ansprechpartner.getText(), ltf_proBeschreibung.getText(), ltf_anfangsDatum.getText(),
					ltf_endDatum.getText(), ltf_tage.getText(), ltf_trainer.getText(), ltf_ort.getText(),
					ltf_bemerkung.getText());
		}
	}

	/**
	 * FocusListener für das EndDatum ltf focusLost Methode nutzen, um daten zu
	 * berechen
	 * 
	 * @author joern
	 */
	public class ltf_EndDatum_FocusListener implements FocusListener {
		...
		public void focusLost(FocusEvent e) {
			ltf_tage.setText(controller.datumsfelderBerechnen(ltf_anfangsDatum.getText(), ltf_endDatum.getText(),
					ltf_tage.getText(), "Enddatum"));
		}
	}

	/**
	 * FocusListener für das Tage ltf focusLost Methode nutzen, um daten zu berechen
	 * 
	 * @author joern
	 */
	public class ltf_Tage_FocusListener implements FocusListener {
		...
		@Override
		public void focusLost(FocusEvent e) {
			ltf_endDatum.setText(controller.datumsfelderBerechnen(ltf_anfangsDatum.getText(), ltf_endDatum.getText(),
					ltf_tage.getText(), "Tage"));
		}
	}
}