...
public class VTrainingSuchen extends JFrame {
	...
	public void init() {
		...
		//TrainingsID-Liste einfügen
		trainingsID = new JList<String>(getTrainingIDs());
		JScrollPane jpane = new JScrollPane(trainingsID);
		pnl_North.add(jpane, BorderLayout.CENTER);
	...
	public class btn_training_auswaehlen_ActionListener implements
	ActionListener {
		@Override
	...
	/**
	 * ActionListener fuer btn_zurueck verlässt Produktdefinieren Fenster
	 * 
	 * @author toni
	 */
