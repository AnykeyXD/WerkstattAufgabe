...
public class CDbAccess {
	...
	private CDbAccess() {
		 ...
		 * @author Nils Winkel
		 * */
		MProdukt produkt_GWW = new MProdukt(
				"GWW",
				"Grundlagen Warenwirtschaft (Kürzel GWW)",
		...
		MProdukt produkt_EWW = new MProdukt(
				"EWW",
				"Erweiterte Grundlagen Warenwirtschaft (Kürzel EWW)",
		...
		MProdukt produkt_WWP = new MProdukt(
				"WWP",
				"Produkt Warenwirtschaft Pro (Kürzel WWP)",
		 ...
		 */
		// Wallau
		MOrt ort_WA01 = new MOrt(1, "Geschäftsstelle Wallau", "Gebäude A", 1,
				"01");
		MOrt ort_WA02 = new MOrt(2, "Geschäftsstelle Wallau", "Gebäude A", 1,
				"02");
		// Hofheim
		MOrt ort_HO01 = new MOrt(3, "Geschäftsstelle Hofheim", "Gebäude K", 2,
				"01");
		MOrt ort_HO02 = new MOrt(4, "Geschäftsstelle Hofheim", "Gebäude K", 2,
				"02");
		// Nürnberg
		MOrt ort_NUE01 = new MOrt(5, "Geschäftsstelle Nürnberg", "Gebäude L",
				1, "03");
		MOrt ort_NUE02 = new MOrt(6, "Geschäftsstelle Nürnberg", "Gebäude L",
				3, "01");
		...
		MTrainer trainer_RS = new MTrainer(3, "Ralf", "Siehgel",
				"GWW, EWW, WWP");
		...
		MAdresse adresse_Aeron = new MAdresse(1, "Rainer-Kausing-Straße 4",
				"Hessen", "Hochheim/Main", "65239");
		MAdresse adresse_Agosini = new MAdresse(2, "Kanzlereistraße 17",
				"Baden-Württemberg", "Pforzheim", "75175");
		MAdresse adresse_Eton = new MAdresse(3, "Hardterring 8",
				"Baden-Württemberg", "Stockach", "78333");

		/** Erstellung der Kunden-Objekte (Beispieldaten) */
		MKunde kunde_Aeron = new MKunde(1, "Aeron Pumpen GmbH",
				"Heinrich Klaist", adresse_Aeron, "+49 6146 6939",
				"Pharmaindustrie", adresse_Aeron.getBundesland(),
				"info@aeronpump-it.de");
		MKunde kunde_Agosini = new MKunde(2, "Agosini", "Maria Jung",
				adresse_Agosini, "+49 7231 9611", "Edelmetallverarbeitung",
				adresse_Agosini.getBundesland(), "info@agosini.de");
		MKunde kunde_Eton = new MKunde(3, "ETONGRUPPE", "Dietmar Bohlen",
				adresse_Eton, "+49 7771 8191", "Automobilzulieferer",
				adresse_Eton.getBundesland(), "info@etongruppe.com");

		MRessource ressource_Test = new MRessource(ort_WA01, trainer_SI,
				produkt_WWP);
		...
		MTraining training_Neu = new MTraining("1", kunde_Aeron,
				ressource_Test, LocalDate.parse("12.12.2017",
						SuperController.formatter), LocalDate.parse(
						"01.01.2000", SuperController.formatter), 2, "test");
		MTraining training_Neu2 = new MTraining("2", kunde_Agosini,
				ressource_Test, LocalDate.parse("12.12.2017",
						SuperController.formatter), LocalDate.parse(
						"01.01.2000", SuperController.formatter), 2, "test");
	...
	public void createKunde(int pKundenID, String pFirmenname,
			String pAnsprechpartner, MAdresse adresse, String pTelefon,
			String pBranche, String pBundesland, String pEmail) {
		kunde_Map.put(pKundenID, new MKunde(pKundenID, pFirmenname,
				pAnsprechpartner, adresse, pTelefon, pBranche, pBundesland,
				pEmail));
	}
	...
	public void createAdresse(int pAdressID, String pStrasse,
			String pBundesland, String pStadt, String pPlz) {
		adresse_Map.put(pAdressID, new MAdresse(pAdressID, pStrasse,
				pBundesland, pStadt, pPlz));
	}
	...
	public void createTrainer(int pTrainerID, String pVorname, String pName,
			String pProdukte) {
		trainer_Map.put(pTrainerID, new MTrainer(pTrainerID, pVorname, pName,
				pProdukte));
	}
	...
	public void createOrt(int portsID, String pGeschaeftsstelle,
			String pGebaeude, int pEtage, String pRaum) {
		ort_Map.put(portsID, new MOrt(portsID, pGeschaeftsstelle, pGebaeude,
				pEtage, pRaum));
	}
	...
	public void createProdukt(String pProduktID, String pBezeichnung,
			String pBeschreibung) {
		produkte_Map.put(pProduktID, new MProdukt(pProduktID, pBezeichnung,
				pBeschreibung));
	}
	...
	public void createTraining(String pTrainingID, MKunde pKunde,
			MRessource pRessource, LocalDate pAnfangsdatum,
			LocalDate pEnddatum, int pTage, String pBemerkungen) {
		training_Map.put(pTrainingID, new MTraining(pTrainingID, pKunde,
				pRessource, pAnfangsdatum, pEnddatum, pTage, pBemerkungen));
	}
...
/*
 * public Object[] getTrainer(){ Collection<MTrainer> values =
 * trainer_Map.values();
 * 
 * MTrainer[] obj_keys = new MTrainer[trainer_Map.values().size()]; for (int
 * i=0; i < trainer_Map.values().size(); i++){ obj_keys[i] = values.(i); }
 * return obj_keys; }
 */
